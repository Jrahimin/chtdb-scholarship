...
<br/><br/>
<form name="form" action="data_input.php" method="post" enctype="multipart/form-data"  accept-charset="UTF-8">
...
-
	...
	<option value="২য়">২য়</option>
                            ...
                            <div class="subbut" id="dekhao">
                                <input name="submit-" id="gapply" type="submit-" value="আবেদনের সময় শেষ হয়েছে" class="btnsub" onClick="check(even)" style="font-weight:bold;border-radius:8px;box-shadow:2px 2px 3px 4px rgb(83,157,2)"/>
                            </div>
                        </div>
                    </td>
                </tr>
