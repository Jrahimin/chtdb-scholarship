...
function check(event) {
    ...
    if (pointValue === "" && carlmarks === "") {
        alert("অনুগ্রহ করে সর্বশেষ উত্তীর্ণ শ্রেণি/ডিগ্রি অথবা সেমিষ্টার/বর্ষের জিপিএ/বিভাগ/নম্বর প্রদান করুন");
        event.preventDefault();
    }
...
function pst() {
    var permanentUnionVal = document.getElementById("pa_union").value;
    var presentUnionVal = document.getElementById("pr_union").value;

    if (permanentUnionVal != presentUnionVal) {
        document.getElementById("mycheck").checked = false;
        document.getElementById("store2").innerHTML = "unchecked";
    }
}
...
function current2() {
    ...
    switch (gotmine) {
        case "এসএসসি/সমমান":
        case "এইচএসসি/সমমান":
            $("#crrange").html('<option value="৫">৫</option>');
            break;
        case "ডিপ্লোমা":
        case "এমবিবিএস/বিডিএস":
        case "ডিভিএম":
        ...
        case "স্নাতক (পাশ)":
        case "স্নাতক/সম্মান":
            $("#crrange").html('<option value="৪">৪</option>');
            break;
    }
...
function qtchange() {
    ...
    switch (cqt) {
        case "":
            ...
            $(".epic").removeAttr("required");
            break;

        case "মুক্তিযোদ্ধা":
            document.getElementById("quota_relation_label").style.display = "block";
            ...
            $(".quota_relation").attr("required", "required");
            break;
...
function changekar(x) {
    var ranga = document.getElementById("hideranga").innerHTML;
    ...
    switch (xyz) {
        case  "রাঙামাটি":
            ...
            document.getElementById("upz").innerHTML = ranga;
            break;
        case  "বান্দরবান":
            document.getElementById("upz").innerHTML = "";
            document.getElementById("upz").innerHTML = bandar;
            break;

        case "খাগড়াছড়ি":
            document.getElementById("upz").innerHTML = "";
            document.getElementById("upz").innerHTML = khag;
            break;
    }
}
